...
int main(int argc, char **argv) {
	...
	switch(qualFunctorUsar) {
		...
		case 2: //implemente seus proprios functors e os teste...
			cout << "Testando com o functor 2 (usando a soma dos codigos ASCII mod 10)" << endl;
		...
		case 4:
			...
			break;
		case 5:
			cout << "Testando com o functor 5 (.....)" << endl;
			testaHash<MyStringHash5>(chaves); //realiza o teste usando o functor MyStringHash4
			break;
	}
